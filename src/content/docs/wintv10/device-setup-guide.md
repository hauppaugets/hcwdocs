...
[Digital ATSC](#scanning-for-atsc-channels-digital-over-the-air-tv-north-america) - Digital terrestrial TV using an antenna (North America only)

[Digital QAM](#scanning-for-clear-qam-digital-cable-tv-channels-north-america) - Digital cable TV (Clear QAM, North America only)

[Analog TV (Antenna/Cable)](#channel-scan-for-analog-tv-cable-or-antenna) - Analog TV over antenna or cable

[Analog TV via Set Top Box](#channel-search-for-analog-tv-via-set-top-box) - Analog TV using a cable or satellite box

[External Inputs (Composite/S-Video)](#configuring-external-video-inputs) - For configuration of the analog video inputs

[Analog FM Radio](#channel-search-for-fm-radio-stations) - Analog FM radio

You can select one or multiple selections if your product is capable of multiple inputs.

If you have a HD PVR 2 or Colossus device, please go to [HD Capture Devices](/hcwdocs/wintv10/external-inputs#hd-pvr-2-and-colossus-2)

If you need to re-run the Device Setup Wizard please go to the [Devices](/hcwdocs/wintv10/settings#settings--devices) menu in WinTV Settings.
...
- If you are using an indoor antenna, position it near to a window. Use a signal reception map to find the best location. [www.dtv.gov](https://www.fcc.gov/media/engineering/dtvmaps)
